...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/M3UKit/M3UKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MahsaHLSParser/MahsaHLSParser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Protobuf/Protobuf.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SPIndicator/SPIndicator.framework"
